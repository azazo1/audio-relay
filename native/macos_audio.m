...
- (instancetype)initWithSampleRate:(uint32_t)sampleRate
  ...
  tapDescription.name = [NSString stringWithFormat:@"audio-relay-tap-%p", self];
  ...
  NSDictionary *aggregate = @{
    @kAudioAggregateDeviceNameKey: [NSString stringWithFormat:@"audio-relay-aggregate-%p", self],
    @kAudioAggregateDeviceUIDKey: [NSString stringWithFormat:@"dev.audio-relay.aggregate-%p", self],
